...
const FigmaIcon: React.FC<IconProps> = (props) => {
    const { className, style } = props;

    const mergedCls = classNames('vc-icon-figma', className);

    return (
        <IconBase className={mergedCls} style={style}>
            <svg fill="none" version="1.1" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em">
