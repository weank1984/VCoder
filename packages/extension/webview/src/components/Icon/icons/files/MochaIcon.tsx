...
const MochaIcon: React.FC<IconProps> = (props) => {
    const { className, style } = props;

    const mergedCls = classNames('vc-icon-mocha', className);

    return (
        <IconBase className={mergedCls} style={style}>
            <svg xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 192 192" width="1em" height="1em">
                <g fill="#a1887f">
