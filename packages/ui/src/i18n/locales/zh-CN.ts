export default {
  Common: {
    ...
    SearchHistoryPlaceholder: '搜索会话...',
    AllTools: '全部工具',
    Ecosystem: 'CLI 生态',
    EcosystemMcp: 'MCP 服务器',
    EcosystemSkills: '技能',
    EcosystemHooks: 'Hooks',
    EcosystemPlugins: '插件',
    EcosystemNoMcp: '未配置 MCP 服务器',
    EcosystemNoSkills: '未找到技能',
    EcosystemNoHooks: '未配置 Hooks',
    EcosystemNoPlugins: '未安装插件',
    EcosystemAddMcp: '添加服务器',
    EcosystemServerName: '名称',
    EcosystemServerType: '类型',
    EcosystemServerCommand: '命令',
    EcosystemServerUrl: 'URL',
    EcosystemAdd: '添加',
    EcosystemBuiltin: '内置',
    EcosystemGlobal: '全局',
    EcosystemWorkspace: '工作区',
    CreateSession: '+ 新建会话',
    ExpandSidebar: '展开侧边栏',
    ...
    AgentTeams: 'Agent 团队',
    AgentTeamsExperimental: '实验性',
    AgentTeamsDescription: '协调多个 Claude Agent 并行处理复杂任务。每个 Agent 拥有专属工具并自主工作。',
    AgentTeamsEnablePrompt: '启用 Agent 团队功能，解锁复杂工作流的多 Agent 协作。',
    AgentTeamsEnable: '启用 Agent 团队',
    AgentTeamsDisable: '禁用',
    AgentTeamsCreateTeam: '创建新团队',
    AgentTeamsTeamName: '团队名称',
    AgentTeamsDescription2: '描述（可选）',
    AgentTeamsCreate: '创建',
    AgentTeamsHowItWorks: 'Agent 团队工作原理',
    AgentTeamsStep1: '创建团队并定义整体目标',
    AgentTeamsStep2: '通过 Task 工具派生专属子 Agent',
